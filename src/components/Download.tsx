  ...
  const triggerActualFileDownload = async () => {
    try {
      ...
      if (downloadFileType === 'file' || platFileType === 'file') {
        // Stream directly from the server filesystem for high performance and original file integrity
        const link = document.createElement('a');
        link.href = '/api/download-installer';
        // Do NOT override download attribute on client-side so the browser honors the original Unicode filename in Content-Disposition header
