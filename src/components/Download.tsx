...
export default function DownloadSection() {
  ...
  const triggerActualFileDownload = async () => {
    try {
      ...
      if (platFileType === 'file') {
        const base64 = activePlatform?.uploadedFileBase64 || uploadedFileBase64;
        if (base64) {
                      ...
                      {visiblePlatforms.map((platform) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[9px] font-bold uppercase tracking-wider font-sans truncate max-w-full px-0.5">
                              {platform.name}
                            </span>
                            {isAuto && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent relative z-10">
                        {downloadBtnText} ({activePlatform?.name || 'Nexus'})
                      </span>
                    </button>
                  </div>
