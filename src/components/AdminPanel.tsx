                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                          ...
                          <div className="lg:col-span-7 bg-[#0b0b14]/75 border border-white/5 rounded-3xl p-6 space-y-4">
                            ...
                            <div className="space-y-4">
                              ...
                              {/* Target Delivery Mechanism (Permanently set to Custom File Upload from PC) */}
                              <div className="space-y-2 border-t border-white/5 pt-3">
                                ...
                                <div className="flex items-center gap-2 text-xs text-slate-300">
                                  ...
                                  <span className="text-emerald-400 font-bold bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1.5 rounded-xl">Свой файл с ПК ⬆ (Активен)</span>
                                </div>
                              </div>
