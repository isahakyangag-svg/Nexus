...
import { Download, Headset, Circle, Mic, MicOff, Sparkles, ShieldAlert } from 'lucide-react';
import { useAdmin } from '../context/AdminState';

export default function Hero() {
  const { theme, language, heroTagline, heroDescription, broadcastMessage, t } = useAdmin();
  ...
  return (
    <section id="home" className="relative pt-32 pb-20 md:py-40 flex items-center justify-between">
      {/* Dynamic Master Announcement Bar */}
      <AnimatePresence>
        {broadcastMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className={`absolute top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-4xl border backdrop-blur-md px-4 py-2.5 rounded-2xl text-center z-40 select-none shadow-lg ${
              theme === 'light'
